...
public class EntityNotFoundException extends WebApplicationException implements JSONExceptionable {


    private final String internalMessage;
    private final String userMessage;

    public EntityNotFoundException(String internalMessage, String userMessage) {
